...
import { FileText, Copy, CheckCircle2, Send, AlertCircle, Trash2, ListFilter } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-sm font-medium">Generating Scope Document</h3>
                    <div className="text-xs text-muted-foreground">Creating a detailed scope document for {client.name}</div>
                  </div>
                </div>
